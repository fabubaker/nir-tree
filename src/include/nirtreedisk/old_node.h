...
/***
 * NOTE: This file contains the old implementation the NIR-Tree node.
 * It contains functions for online inserts and updates, which are unnecessary
 * for the static NIR-Tree. Some of the functions here have been reused in
 * main "node.h" file.
 */
...
tree_node_handle unpack_branch(
  ...
  new (&(*branch_node)) BRANCH_NODE_CLASS_TYPES(treeRef, parent_handle, branch_handle, level);
