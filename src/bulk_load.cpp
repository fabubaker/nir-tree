...
void fill_branch(
  ...
  using LN = rstartreedisk::LeafNode<R_STAR_MIN_FANOUT, R_STAR_FANOUT>;
  using BN = rstartreedisk::BranchNode<R_STAR_MIN_FANOUT, R_STAR_FANOUT>;
...
std::vector<tree_node_handle> str_packing_branch(
  ...
  rstartreedisk::LeafNode<R_STAR_MIN_FANOUT, R_STAR_FANOUT> *targ = nullptr;
  rstartreedisk::BranchNode<R_STAR_MIN_FANOUT, R_STAR_FANOUT> *targ2 = nullptr;
...
void basic_split_leaf(
        ...
        unsigned height, 
        uint64_t M, 
        pinned_node_ptr<rstartreedisk::LeafNode<R_STAR_MIN_FANOUT, R_STAR_FANOUT>> leaf_node)
{
...
void bulk_load_tree(
  ...
  std::cout << "Num els: " << num_els << std::endl;
  std::cout << "Max depth required: " << max_depth << std::endl;
  std::cout << "Size of R* branch node: " << sizeof(rstartreedisk::BranchNode<R_STAR_MIN_FANOUT, R_STAR_FANOUT>) << std::endl;
